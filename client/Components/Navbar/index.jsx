...
const Navbar = () => {
  ...
  return (
    <header
      className={`absolute left-0 top-0 z-20 flex w-full items-center overflow-hidden  shadow-lg shadow-blue-100`}
    >
      ...
      <div className="container">
        <div className="relative -mx-4 flex items-center justify-between">
          <div className=" w-full px-4">
            <a
              href="/#"
              className="block w-full py-5 font-pop text-2xl px-4 font-semibold text-blue-800"
            >
              Health Mate
            </a>
          </div>
          <div className="flex w-full items-center justify-between px-4">
            ...
            <div className=" sm:flex lg:pr-0">
              {user ? (
                <div className="font-pop flex flex-row justify-center items-center gap-2">
                  Welcome, {user?.name}
                  <img className="rounded-full w-8 h-8" src={user?.img} />
                  <div
                    onClick={logout}
                    className="flex gap-1  flex-row bg-gradient-to-r from-blue-700 via-sky-600 to-sky-700 text-white p-1 justify-center items-center rounded-full px-2 cursor-pointer"
                  >
                    Logout
                    <svg
