...
const Features = () => {
  ...
  return (
    ...
    <div class="flex justify-between gap-4 font-pop mb-[5rem] mx-4">
...
System</h5>
        ...
        <a href="#" class="inline-flex items-center mt-8 px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Explore
             <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
            </svg>
    ...
    <div class="p-5">
        <a href="#">
            <h5 class="mb-2 text-2xl font-bold tracking-tight bg-gradient-to-r from-blue-700 via-sky-600 to-sky-700 text-transparent bg-clip-text ">AI-Powered ​ Disease Diagnosis​
</h5>
        </a>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">HealthMate's AI-Powered Disease Diagnosis employs cutting-edge technology to deliver swift and accurate assessments.</p>
