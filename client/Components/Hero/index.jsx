          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-5/12">
              <div className="hero-content">
                <h1 className="mb-5 font-pop text-3xl font-bold !leading-[1.208] text-dark  sm:text-[35px] lg:text-[35px] xl:text-5xl bg-gradient-to-r from-blue-700 via-sky-600 to-sky-700 text-transparent bg-clip-text">
