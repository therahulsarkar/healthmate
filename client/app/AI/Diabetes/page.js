...
const Diabetes = () => {
  ...
  return (
    <>
      <h1 className='font-bold font-pop text-blue-500 text-4xl text-center m-10'>Discover Your Diabetes Risk Today, and Take Control of Your Health</h1>
      <div className='max-w-full font-pop flex justify-center items-center bg-slate-100'>
        <div className='max-w-full  font-bold  rounded-2xl shadow-xl bg-white mt-7 mb-10'>
